# Glip OpenAPI Specification
[![Build Status](https://travis-ci.org/pkvenu/glip-openapi-spec.svg?branch=master)](https://travis-ci.org/pkvenu/glip-openapi-spec)
...
- Documentation(ReDoc): https://pkvenu.github.io/glip-openapi-spec/
- SwaggerUI: https://pkvenu.github.io/glip-openapi-spec/swagger-ui/
- Look full spec:
    + JSON https://pkvenu.github.io/glip-openapi-spec/swagger.json
    + YAML https://pkvenu.github.io/glip-openapi-spec/swagger.yaml
- Preview spec version for branch `[branch]`: https://pkvenu.github.io/glip-openapi-spec/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://pkvenu.github.io/glip-openapi-spec/ with url from the message: `Server started <url>`
